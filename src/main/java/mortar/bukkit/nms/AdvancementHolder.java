...
public abstract class AdvancementHolder
{
	...
	public AdvancementHolder(String id, Plugin p)
	{
		pl = p;
		this.id = new NamespacedKey(p, "story/" + id);
	...
	public void delete(Player... player)
	{
		...
		Bukkit.getScheduler().scheduleSyncDelayedTask(pl, new Runnable()
		{
			...
			public void run()
			{
				removeAdvancement(getID());
			}
		}, 5);
	}

	public abstract void removeAdvancement(NamespacedKey k);

	public abstract String getMinecraftIDFrom(ItemStack stack);
