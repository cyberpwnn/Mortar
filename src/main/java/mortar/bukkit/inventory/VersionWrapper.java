...
public interface VersionWrapper
{
	 ...
	 * 
	 * @param player
	 *            The player to get the next container id of
	 ...
	 * 
	 * @param player
	 *            The player that needs their current inventory closed
	 */
	 ...
	 * 
	 * @param player
	 *            The player to set the active container of
	 */
	 ...
	 *            The player to set the active container of
	 * @param container
	 *            The container to set as active
	 */
	 ...
	 * 
	 * @param container
	 *            The container to set the windowId of
	 * @param containerId
	 *            The new windowId
	 */
	 ...
	 * 
	 * @param container
	 *            The container to add the slot listener to
	 * @param player
	 *            The player to have as a listener
	 */
	 ...
	 * 
	 * @param container
	 *            The NMS container to get the {@link Inventory} of
	 ...
	 * 
	 * @param player
	 *            The player to get the container of
