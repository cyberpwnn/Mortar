...
import net.minecraft.server.v1_14_R1.TickListServer;
import net.minecraft.server.v1_14_R1.WorldServer;

public class Catalyst14 extends CatalystPacketListener implements CatalystHost
{
	...
	public void setBlock(Location l, MaterialBlock m)
	{
		...
		{
			chunk.getSections()[y >> 4] = new net.minecraft.server.v1_14_R1.ChunkSection(y >> 4 << 4);
		}

		net.minecraft.server.v1_14_R1.ChunkSection sec = chunk.getSections()[y >> 4];
